    ...
    return (
        <main className="min-h-screen px-6 py-12 md:px-12 lg:px-24">
            <div className="max-w-6xl mx-auto space-y-12">
                ...
                <div className="bg-white rounded-[2rem] border-2 border-zinc-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)]">
                    <div className="bg-zinc-50/50 border-b border-zinc-100 px-8 py-4 flex items-center gap-2 rounded-t-[2rem]">
                        <h2 className="font-bold text-zinc-900">Materialbewegungen</h2>
